...
typedef struct _EMAC_Config {
    combo        ModeFlags;      /* Configuation Mode Flags                */
    combo        MdioModeFlags;  /* CSL_MDIO Mode Flags (see CSL_MDIO.H)   */
    combo        TxChannels;     /* Number of Tx Channels to use (1-8)     */
    Uint8       MacAddr[6];     /* Mac Address                            */
    combo        RxMaxPktPool;   /* Max Rx packet buffers to get from pool */
...
typedef struct _EMAC_Status {
    combo        MdioLinkStatus; /* CSL_MDIO Link status (see CSL_MDIO.H) */
    combo        PhyDev;         /* Current PHY device in use (0-31)      */
    combo        RxPktHeld;      /* Number of packets held for Rx         */
    combo        TxPktHeld;      /* Number of packets held for Tx         */
    combo        FatalError;     /* Fatal Error when non-zero             */
} EMAC_Status;
...
* by this function.
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_enumerate( void );
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_open( int physicalIndex, Handle hApplication,
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_close( Handle hEMAC );
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_getStatus( Handle hEMAC, EMAC_Status *pStatus );
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_setReceiveFilter( Handle hEMAC, combo ReceiveFilter );
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_getReceiveFilter( Handle hEMAC, combo *pReceiveFilter );
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_getStatistics( Handle hEMAC, EMAC_Statistics *pStatistics );
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_setMulticast( Handle hEMAC, combo AddrCnt, Uint8 *pMCastList );
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_sendPacket( Handle hEMAC, EMAC_Pkt *pPacket );
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_serviceCheck( Handle hEMAC );
...
*
\*-----------------------------------------------------------------------*/
CSLAPI combo EMAC_timerTick( Handle hEMAC );
