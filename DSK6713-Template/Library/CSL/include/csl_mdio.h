...
* function.
\*-----------------------------------------------------------------------*/
CSLAPI Handle MDIO_open( combo mdioModeFlags );
...
\*-----------------------------------------------------------------------*/
CSLAPI void MDIO_getStatus( Handle hMDIO, combo *pPhy, combo *pLinkStatus );
...
\*-----------------------------------------------------------------------*/
CSLAPI combo MDIO_timerTick( Handle hMDIO );
...
\*-----------------------------------------------------------------------*/
CSLAPI combo MDIO_initPHY( Handle hMDIO, combo phyAddr );
...
\*-----------------------------------------------------------------------*/
CSLAPI combo MDIO_phyRegRead( combo phyIdx, combo phyReg, Uint16 *pData );
...
\*-----------------------------------------------------------------------*/
CSLAPI combo MDIO_phyRegWrite( combo phyIdx, combo phyReg, Uint16 data );
